...
public:
  ...
  Tibonacci(const std::vector<int> &other)
      : start_numbers(other), fibonacci_numbers(other.size()) {}
  ...
  std::vector<uint64_t> get_fibonacci_numbers() const {
    return fibonacci_numbers;
  }
  uint64_t get_fibonacci_number(size_t index) const {
